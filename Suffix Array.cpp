// Obs: Colocar um " " espaço a mais no final da string para implementar os
// algoritmos;
...
// Se string p é substring de s, retorna a primeira posição do vetor de sufixo
// que p é substring
...
// Se string p é substring de s, retorna a ultima posição do vetor de sufixo que
// p é substring
...
// Necessário implementar SegTree ou Sparse table no array LCP para buscar o
// menor no range (x+1,y);
bool cmp(pair<int, int> a, pair<int, int> b) {
  ...
  if (menor < min(a.second - a.first + 1, b.second - b.first + 1)) {
    ...
    return a.second - a.first + 1 < b.second - b.first + 1 or
           (a.second - a.first + 1 == b.second - b.first + 1 and a < b);
  }
}