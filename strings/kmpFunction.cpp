...
struct KMP {
  ...
  // constroi automato em q a posição i diz quantos caracters antes de i são
  // iguais ao do prefixo
  ...
  // retorna qual o próximo estado e se o estado atual causa um match com o
  // pattern inteiro
  ...
  // retorna todas as posições de s em que da um match com o pattern (as
  // posições iniciais das substrings que dão match)
